...
# router = APIRouter(tags=["Progress-Monitoring"])
...
# @router.post("/log-measurement", response_model=ProgressResponse)
# def log_measurement(request: MeasurementRequest) -> ProgressResponse:
...
# @router.post("/log-workout", response_model=ProgressResponse)
# def log_workout(request: WorkoutRequest) -> ProgressResponse:
...
# @router.post("/log-feedback", response_model=ProgressResponse)
# def log_subjective_feedback(request: FeedbackRequest) -> ProgressResponse:
...
# @router.post("/progress-history", response_model=ProgressHistoryResponse)
# def get_progress_history(request: ProgressHistoryRequest) -> ProgressHistoryResponse:
...
# def get_progress_summary(request: ProgressSummaryRequest) -> ProgressSummaryResponse:
