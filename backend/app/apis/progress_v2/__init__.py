...
router = APIRouter(tags=["MCP-Progress-V2"])
...
@router.post("/mcp/progress/log-measurement", response_model=ProgressResponse)
def mcp_log_measurement(request: MeasurementRequest) -> ProgressResponse:
...
@router.post("/mcp/progress/log-workout", response_model=ProgressResponse)
def mcp_log_workout(request: WorkoutRequest) -> ProgressResponse:
...
@router.post("/mcp/progress/log-feedback", response_model=ProgressResponse)
def mcp_log_subjective_feedback(request: FeedbackRequest) -> ProgressResponse:
...
@router.post("/mcp/progress/history", response_model=ProgressHistoryResponse)
def mcp_get_progress_history(request: ProgressHistoryRequest) -> ProgressHistoryResponse:
...
@router.post("/mcp/progress/summary", response_model=ProgressSummaryResponse)
def mcp_get_progress_summary(request: ProgressSummaryRequest) -> ProgressSummaryResponse:
